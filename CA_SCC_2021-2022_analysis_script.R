...
# write.csv(flat.all,
#           "Z:/Group_work/PS_AA/Child Asthma/SCC 2019/Data/tidyData/CA_SCC_2019_report_data_2020-07-30.csv",
#           row.names = FALSE)


# write.csv(flat.all,
#           "Z:/Group_work/PS_AA/Child Asthma/SCC 2019/Data/tidyData/CA_SCC_2019_report_data_2020-04-16.csv",
#           row.names = FALSE)
...
# write.csv(flat.all,
#           "Z:/Group_work/PS_AA/CYP Asthma Secondary Care Clinical 2021-2022/Data/dataStore/CA_SCC_2021-2022_hospital_level_data_2022-07-03_all.csv",
#           row.names = FALSE)
